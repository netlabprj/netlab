...
0
|| checktplrefresh('./template/kym_xiaomi/forum/viewthread.htm', './template/kym_xiaomi/munelist/viewtitle.htm', 1436860734, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', './template/kym_xiaomi', 'forum/viewthread')
|| checktplrefresh('./template/kym_xiaomi/forum/viewthread.htm', './template/kym_xiaomi/munelist/pingfen.htm', 1436860734, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', './template/kym_xiaomi', 'forum/viewthread')
|| checktplrefresh('./template/kym_xiaomi/forum/viewthread.htm', './template/kym_xiaomi/forum/viewthread_node.htm', 1436860734, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', './template/kym_xiaomi', 'forum/viewthread')
|| checktplrefresh('./template/kym_xiaomi/forum/viewthread.htm', './template/kym_xiaomi/forum/viewthread_fastpost.htm', 1436860734, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', './template/kym_xiaomi', 'forum/viewthread')
|| checktplrefresh('./template/kym_xiaomi/forum/viewthread.htm', './template/kym_xiaomi/forum/viewthread_node_body.htm', 1436860734, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', './template/kym_xiaomi', 'forum/viewthread')
|| checktplrefresh('./template/kym_xiaomi/forum/viewthread.htm', './template/default/common/seditor.htm', 1436860734, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', './template/kym_xiaomi', 'forum/viewthread')
|| checktplrefresh('./template/kym_xiaomi/forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1436860734, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', './template/kym_xiaomi', 'forum/viewthread')
|| checktplrefresh('./template/kym_xiaomi/forum/viewthread.htm', './template/default/common/upload.htm', 1436860734, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', './template/kym_xiaomi', 'forum/viewthread')
|| checktplrefresh('./template/kym_xiaomi/forum/viewthread.htm', './template/default/common/seccheck.htm', 1436860734, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', './template/kym_xiaomi', 'forum/viewthread')
...
<div class="z">
<a href="forum.php"><?php echo $_G['setting']['navs']['2']['navname'];?></a><?php echo $navigation;?> <em>&rsaquo;</em> <a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>"><?php echo $_G['forum_thread']['short_subject'];?></a>
</div>
</div>
...
<div id="ct" class="wp cl ct2 xm_ct2"><div class="xm_tp">
<div class="xm_p_tp">
<div class="y">
...
<a class="xm_avt" href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" target="_blank"><img src="uc_server/avatar.php?uid=<?php echo $thread['authorid'];?>&amp;size=small" /></a>
<h1><a id="thread_subject"><?php echo $_G['forum_thread']['subject'];?></a></h1>
<div class="xm_tp_action">
                        <span><a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>"><?php echo $thread['author'];?></a></span>
                        <span>于<?php echo $post['dateline'];?>发表</span>
...
<?php } ?>
     <?php } ?>
                        ...
                        <?php if(in_array($thread['displayorder'], array(1, 2, 3, 4))) { ?><span><em style="color: #ed5669;">置顶</em> </span><?php } ?>
<span class="xg1"><?php if($post['invisible'] == 0) { if(!IS_ROBOT && !$_GET['authorid'] && !$_G['forum_thread']['archiveid']) { ?>
...
<?php } } if(!IS_ROBOT) { if($post['invisible'] == 0) { ?><a href="forum.php?mod=viewthread&amp;action=printable&amp;tid=<?php echo $_G['tid'];?>" title="打印" target="_blank">[打印]</a>
<?php } ?>
<a href="forum.php?mod=redirect&amp;goto=nextoldset&amp;tid=<?php echo $_G['tid'];?>" title="上一主题">[上一主题]</a>
<a href="forum.php?mod=redirect&amp;goto=nextnewset&amp;tid=<?php echo $_G['tid'];?>" title="下一主题"> [下一主题]</a>
<?php } ?>  
...
<div class="sd xm_sd"><div id="post_act" style="">

            <div class="bm xm_bm post_new">
                <div class="bm_c">
               
<?php if(!$_G['forum_thread']['is_archived']) { ?>
<a id="newspecialtmp" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> href="javascript:;" title="发新帖"><img alt="发新帖" src="template/kym_xiaomi/style/images/pn_post_big.png" /></a>
<?php } ?>
...
<a data="r" href="forum.php?mod=post&amp;action=reply&amp;fid=<?php echo $_G['fid'];?>&amp;tid=<?php echo $_G['tid'];?>&amp;reppost=<?php echo $post['pid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?>" onclick="showWindow('reply', this.href)">回复&nbsp;</a><?php } else { ?><span>回复</span>
<?php } ?>
...
<?php if($allowblockrecommend) { ?><a href="javascript:;" onclick="modaction('recommend', '<?php echo $_G['forum_firstpid'];?>', 'op=recommend&idtype=<?php if($_G['forum_thread']['isgroup']) { ?>gtid<?php } else { ?>tid<?php } ?>&id=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?>', 'portal.php?mod=portalcp&ac=portalblock')">推送</a><?php } else { ?><span>推送</span><?php } ?>
                                                    </li>
                        <li class="a3">
                                                            <!--不能点-->
                               
<?php if(!$post['anonymous'] && helper_access::check_module('follow')) { ?>
<a id="ak_rate" href="home.php?mod=spacecp&amp;ac=follow&amp;op=relay&amp;tid=<?php echo $_G['tid'];?>&amp;from=forum" onclick="showWindow('relaythread', this.href, 'get', 0);" title="转播求扩散">转播</a><?php } else { ?><span>转播</span>
<?php } ?>
                                                    </li>
                        <li class="a4">
<a id="shareLink" href="home.php?mod=spacecp&amp;ac=share&amp;type=thread&amp;id=<?php echo $_G['tid'];?>" onclick="showWindow('sharethread', this.href, 'get', 0);" title="分享推精华" class="a4" >分享</a>
...
postAct.setAttribute("style", "position:fixed; top: 0px; z-index:300; box-shadow: 0 0 5px 2px rgba(0,0,0,0.3);width:240px;" );
} else {
...
<div id="postlist" class="pl kym_postlist_bm"><?php $postcount = 0;?><?php if(is_array($postlist)) foreach($postlist as $post) { if($rushreply && $_GET['checkrush'] && $post['rewardfloor'] != 1) { continue;?><?php } ?>
...
<?php if(!$postcount && !$_G['forum_thread']['archiveid'] && $post['first'] ) { ?><div class="pl_t">
...
<a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=thread&amp;id=<?php echo $_G['tid'];?>&amp;formhash=<?php echo FORMHASH;?>" id="k_favorite" onclick="showWindow(this.id, this.href, 'get', 0);" onmouseover="this.title = $('favoritenumber').innerHTML + ' 人收藏'" title="收藏本帖"><img src="<?php echo IMGDIR;?>/fav.gif" alt="收藏" /></a>
</span><?php } ?>
<span id="fj" class="act_btn y">
...
<tr>
<?php if(!$postcount && !$_G['forum_thread']['archiveid'] && $post['first'] ) { ?><td class="pls" rowspan="2" style="width:0px;"></td><?php } else { ?>
<td class="pls" rowspan="2" style="width:96px;">
<div id="favatar<?php echo $post['pid'];?>" class="favatar">
<?php echo $post['newpostanchor'];?> <?php echo $post['lastpostanchor'];?>
<?php if($post['authorid'] && $post['username'] && !$post['anonymous']) { ?>

<div class="p_pop blk bui xm_card card_gender_<?php echo $post['gender'];?>" id="userinfo<?php echo $post['pid'];?>" style="display:none;">
...
<a target="_blank" href="home.php?mod=spacecp&amp;ac=usergroup&amp;gid=<?php echo $post['authorid'];?>"><?php echo $post['authortitle'];?></a>
</div><?php viewthread_profile_node('top', $post);?></div>

<div class="c_action">                                          
                            <a onclick="showWindow('adduser', this.href, 'get', 0);" href="home.php?mod=spacecp&amp;ac=friend&amp;op=add&amp;uid=<?php echo $post['authorid'];?>&amp;handlekey=addfriendhk_<?php echo $post['authorid'];?>" class="y">加为好友</a>		
                            <a href="home.php?mod=spacecp&amp;ac=pm&amp;op=showmsg&amp;handlekey=showmsg_<?php echo $post['authorid'];?>&amp;touid=<?php echo $post['authorid'];?>&amp;pmid=0&amp;daterange=2&amp;pid=<?php echo $post['pid'];?>&amp;tid=<?php echo $post['tid'];?>" onclick="showWindow('sendpm', this.href);" title="发消息" class="y">发消息</a>

                            <a class="z" target="_blank" href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>">访问家园</a>
                        </div>
</div>
...
<li class="medal">
<a target="_blank" href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>&amp;do=profile">个人资料</a>
</li>
<li class="space">
<a target="_blank" href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>&amp;do=thread&amp;view=me&amp;from=space">主题列表</a>
</li>
<?php } ?>
...
<?php if(!$postcount && !$_G['forum_thread']['archiveid'] && $post['first'] ) { } else { ?>
...
<img src ="<?php echo IMGDIR;?>/settop.png" title="置顶回复" class="vm" /> 1来自 <?php echo $post['number'];?><?php echo $postnostick;?>
...
<span class="author"><a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" class="xw1"<?php if($post['groupcolor']) { ?> style="color: <?php echo $post['groupcolor'];?>"<?php } ?>><?php echo $post['author'];?></a><?php echo $authorverifys;?></span>
<em id="authorposton<?php echo $post['pid'];?>">&nbsp;<span>发表于 <?php echo $post['dateline'];?></span></em>
...
<?php } ?><?php $ad_a_pr=adshow("thread/a_pr/3/$postcount");?><div class="pct"><?php echo adshow("thread/a_pt/2/$postcount");?><?php if(empty($ad_a_pr_css)) { ?>
...
<?php } ?>
<span class="xg1">
发表于 <?php echo dgmdate($comment[dateline], 'u');?><?php if($_G['forum']['ismoderator'] && $_G['group']['allowdelpost']) { ?>&nbsp;<a href="javascript:;" onclick="modaction('delcomment', <?php echo $comment['id'];?>)">删除</a><?php } ?>
</span>
</div>
</div>
...
<a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=thread&amp;id=<?php echo $_G['tid'];?>&amp;formhash=<?php echo FORMHASH;?>" id="k_favorite" onclick="showWindow(this.id, this.href, 'get', 0);" onmouseover="this.title = $('favoritenumber').innerHTML + ' 人收藏'" title="收藏本帖"><img src="<?php echo IMGDIR;?>/fav.gif" alt="收藏" />收藏<span id="favoritenumber"<?php if(!$_G['forum_thread']['favtimes']) { ?> style="display:none"<?php } ?>>&nbsp;<?php echo $_G['forum_thread']['favtimes'];?></span></a>
<?php if($_G['group']['raterange'] && $post['authorid']) { ?>
<a href="javascript:;" id="ak_rate" onclick="showWindow('rate', 'forum.php?mod=misc&action=rate&tid=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?>', 'get', -1);return false;" title="评分表立场"><img src="<?php echo IMGDIR;?>/agree.gif" alt="评分" />评分</a>
<?php } if(!$post['anonymous'] && $post['first'] && helper_access::check_module('follow')) { ?>
<a class="followp" href="home.php?mod=spacecp&amp;ac=follow&amp;op=relay&amp;tid=<?php echo $_G['tid'];?>&amp;from=forum" onclick="showWindow('relaythread', this.href, 'get', 0);" title="转播求扩散"><img src="<?php echo IMGDIR;?>/rt.png" alt="转播" />转播<?php if($_G['forum_thread']['relay']) { ?><span id="relaynumber" style="display:none"><?php echo $_G['forum_thread']['relay'];?></span><?php } ?></a>
<?php } if($post['first'] && helper_access::check_module('share')) { ?>
<a class="sharep" href="home.php?mod=spacecp&amp;ac=share&amp;type=thread&amp;id=<?php echo $_G['tid'];?>" onclick="showWindow('sharethread', this.href, 'get', 0);" title="分享推精华"><img src="<?php echo IMGDIR;?>/oshr.png" alt="分享" />分享<?php if($_G['forum_thread']['sharetimes']) { ?><span id="sharenumber"><?php echo $_G['forum_thread']['sharetimes'];?></span><?php } ?></a>
<?php } if(!$_G['forum']['disablecollect'] && helper_access::check_module('collection')) { ?>
<a href="forum.php?mod=collection&amp;action=edit&amp;op=addthread&amp;tid=<?php echo $_G['tid'];?>" id="k_collect" onclick="showWindow(this.id, this.href);return false;" onmouseover="this.title = $('collectionnumber').innerHTML + ' 人淘帖'" title="淘好帖进专辑"><img src="<?php echo IMGDIR;?>/collection.png" alt="分享" />淘帖<span id="collectionnumber"<?php if(!$post['releatcollectionnum']) { ?> style="display:none"<?php } ?>><?php echo $post['releatcollectionnum'];?></span></a>
<?php } if(($_G['group']['allowrecommend'] || !$_G['uid']) && $_G['setting']['recommendthread']['status']) { if(!empty($_G['setting']['recommendthread']['addtext'])) { ?>
<a id="recommend_add" href="forum.php?mod=misc&amp;action=recommend&amp;do=add&amp;tid=<?php echo $_G['tid'];?>&amp;hash=<?php echo FORMHASH;?>" <?php if($_G['uid']) { ?>onclick="ajaxmenu(this, 3000, 1, 0, '43', 'recommendupdate(<?php echo $_G['group']['allowrecommend'];?>)');return false;"<?php } else { ?> onclick="showWindow('login', this.href)"<?php } ?> onmouseover="this.title = $('recommendv_add').innerHTML + ' 人<?php echo $_G['setting']['recommendthread']['addtext'];?>'" title="顶一下"><img src="<?php echo IMGDIR;?>/rec_add.gif" alt="<?php echo $_G['setting']['recommendthread']['addtext'];?>" /><?php echo $_G['setting']['recommendthread']['addtext'];?><span id="recommendv_add"<?php if(!$_G['forum_thread']['recommend_add']) { ?> style="display:none"<?php } ?>><?php echo $_G['forum_thread']['recommend_add'];?></span></a>
<?php } if(!empty($_G['setting']['recommendthread']['subtracttext'])) { ?>
<a id="recommend_subtract" href="forum.php?mod=misc&amp;action=recommend&amp;do=subtract&amp;tid=<?php echo $_G['tid'];?>&amp;hash=<?php echo FORMHASH;?>" <?php if($_G['uid']) { ?>onclick="ajaxmenu(this, 3000, 1, 0, '43', 'recommendupdate(-<?php echo $_G['group']['allowrecommend'];?>)');return false;"<?php } else { ?> onclick="showWindow('login', this.href)"<?php } ?> onmouseover="this.title = $('recommendv_subtract').innerHTML + ' 人<?php echo $_G['setting']['recommendthread']['subtracttext'];?>'" title="踩一下"><img src="<?php echo IMGDIR;?>/rec_subtract.gif" alt="<?php echo $_G['setting']['recommendthread']['subtracttext'];?>" /><?php echo $_G['setting']['recommendthread']['subtracttext'];?><span id="recommendv_subtract"<?php if(!$_G['forum_thread']['recommend_sub']) { ?> style="display:none"<?php } ?>><?php echo $_G['forum_thread']['recommend_sub'];?></span></a>
<?php } } ?>
...
<div class="post_comment_top" style="margin-top:-10px;">
<h2 style="text-align:center">共 <?php echo $_G['forum_thread']['allreplies'];?> 个关于<?php echo $_G['forum_thread']['subject'];?>的回复 最后回复于<span><?php echo $post['dateline'];?></span></h2>
</div>
...
<div class="pgs cl" style="margin-top: -8px; margin-bottom: 0px; border-bottom:2px solid #F7F7F7"><span class="pgb"<?php if($_G['setting']['visitedforums']) { ?> id="visitedforumstmp" onmouseover="$('visitedforums').id = 'visitedforumstmp';this.id = 'visitedforums';showMenu({'ctrlid':this.id,'pos':'21'})"<?php } ?>><a href="<?php echo $upnavlink;?>">返回列表</a></span><?php echo $multipage;?></div>


<?php if($modmenu['thread']) { ?>
<div class="xi2 mbm pbm bbs kym_edit">
<script type="text/javascript">
...
<div id="f_pst" class="pl<?php if(empty($_GET['from'])) { } ?>" style="margin-top:10px;">
...
<td class="plc" style="padding:0px;">
...
<div<?php if(empty($_GET['from']) && $_G['setting']['fastsmilies']) { } ?> id="fastposteditor">
<div class="arrow">
<em></em>
<span></span>
</div>
...
<a href="forum.php?mod=post&amp;action=reply&amp;fid=<?php echo $_G['fid'];?>&amp;tid=<?php echo $_G['tid'];?><?php if($_GET['from']) { ?>&amp;from=<?php echo $_GET['from'];?><?php } ?>" onclick="return switchAdvanceMode(this.href)" style="color:#878787">高级模式</a>
...
<p class="ptm pnpost" style="padding: 0 20px 20px 20px;height:24px;">
<a href="home.php?mod=spacecp&amp;ac=credit&amp;op=rule&amp;fid=<?php echo $_G['fid'];?>" class="y" target="_blank" style="color:#878787; width:84px;">本版积分规则</a>
<button <?php if($allowpostreply) { ?>type="submit" <?php } elseif(!$_G['uid']) { ?>type="button" onclick="showWindow('login', 'member.php?mod=logging&action=login&guestmessage=yes')" <?php } if(!$seccodecheck) { ?>onmouseover="checkpostrule('seccheck_fastpost', 'ac=reply');this.onmouseover=null" <?php } ?>name="replysubmit" id="fastpostsubmit" class="replytitel" value="replysubmit" tabindex="5" style="background:#ff8000;background:-webkit-linear-gradient(top,#ff8000,#ff6000);background:-moz-linear-gradient(top,#ff8000,#ff6000);background:-ms-linear-gradient(top,#ff8000,#ff6000);background:-o-linear-gradient(top,#ff8000,#ff6000);background:linear-gradient(top,#ff8000,#ff6000);border: 1px solid #EC5621;border-radius: 3px;color: #FFFFFF;font-size:12px; padding:5px 8px;cursor:pointer; text-align:center; margin-left:10px; font-weight:700;">发表回复</button>
