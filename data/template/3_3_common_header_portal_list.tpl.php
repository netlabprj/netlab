...
0
|| checktplrefresh('./template/kym_xiaomi/common/header.htm', './template/default/common/header_common.htm', 1436860525, '3', './data/template/3_3_common_header_portal_list.tpl.php', './template/kym_xiaomi', 'common/header_portal_list')
|| checktplrefresh('./template/kym_xiaomi/common/header.htm', './template/kym_xiaomi/common/header_qmenu.htm', 1436860525, '3', './data/template/3_3_common_header_portal_list.tpl.php', './template/kym_xiaomi', 'common/header_portal_list')
|| checktplrefresh('./template/kym_xiaomi/common/header.htm', './template/kym_xiaomi/member/member.htm', 1436860525, '3', './data/template/3_3_common_header_portal_list.tpl.php', './template/kym_xiaomi', 'common/header_portal_list')
|| checktplrefresh('./template/kym_xiaomi/common/header.htm', './template/kym_xiaomi/common/pubsearch.htm', 1436860525, '3', './data/template/3_3_common_header_portal_list.tpl.php', './template/kym_xiaomi', 'common/header_portal_list')
;?>
