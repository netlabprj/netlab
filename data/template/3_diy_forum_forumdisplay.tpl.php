...
0
|| checktplrefresh('./template/kym_xiaomi/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1436860641, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/kym_xiaomi', 'forum/forumdisplay')
|| checktplrefresh('./template/kym_xiaomi/forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1436860641, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/kym_xiaomi', 'forum/forumdisplay')
|| checktplrefresh('./template/kym_xiaomi/forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1436860641, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/kym_xiaomi', 'forum/forumdisplay')
|| checktplrefresh('./template/kym_xiaomi/forum/forumdisplay.htm', './template/kym_xiaomi/forum/forumdisplay_list.htm', 1436860641, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/kym_xiaomi', 'forum/forumdisplay')
|| checktplrefresh('./template/kym_xiaomi/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1436860641, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/kym_xiaomi', 'forum/forumdisplay')
|| checktplrefresh('./template/kym_xiaomi/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1436860641, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/kym_xiaomi', 'forum/forumdisplay')
|| checktplrefresh('./template/kym_xiaomi/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1436860641, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/kym_xiaomi', 'forum/forumdisplay')
...
<div class="z">
<a href="forum.php"><?php echo $_G['setting']['navs']['2']['navname'];?></a><?php echo $navigation;?> <a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>"><?php echo $_G['forum_thread']['short_subject'];?></a>
</div>
...
<div class="xm_tp">
<div class="xm_l_tp">
<div class="y"><?php if($moderatedby) { ?>版主: <span class="kym_aduser"><?php echo $moderatedby;?></span><?php } ?></div>
<h1>
...
<?php if(rssforumperm($_G['forum']) && $_G['setting']['rssstatus'] && !$_GET['archiveid'] && !$subforumonly) { ?><a href="forum.php?mod=rss&amp;fid=<?php echo $_G['fid'];?>&amp;auth=<?php echo $rssauth;?>" class="fa_rss" target="_blank" title="RSS">订阅</a><?php } if(!empty($forumarchive)) { ?>
...
<div class="ptn xg2" style="padding-bottom: 5px;"><?php echo $_G['forum']['rules'];?></div>
</div>
<?php } ?>
</div>
<?php } ?>
...
<?php if(!$_GET['archiveid']) { ?><a href="javascript:;" class="post_btn" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖"><img alt="发新帖" src="template/kym_xiaomi/style/images/pn_post_big.png"></a><?php } ?>
...
<?php if($leftside) { ?>
<div id="sd_bdl" class="bdl" onmouseover="showMenu({'ctrlid':this.id, 'pos':'dz'});" style="width:130px;margin-left:-130px; margin-top:20px;">
...
<?php } ?>
<div class="kym_mn" style="width:745px; float:left;">
...
<span class="replynumber xg1"><span id="livereplies" class="xi1"><?php echo $livethread['replies'];?></span>人互动</span>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $livethread['tid'];?>" target="_blank"><?php echo $livethread['subject'];?></a>
</div>
...
<p class="kym_ptm pnpost" style="padding-top:10px;text-align:right">
<button type="submit" name="replysubmit" class="pn pnc vm" style="height:41px; border:none; background:none;" value="replysubmit" id="livereplysubmit">
<img src="template/kym_xiaomi/style/images/livefy.png" />
</button>
</p>
...
EOF;
?>
<div class="mtm sec" style="text-align:right; margin-bottom: 2px;"><?php $sechash = !isset($sechash) ? 'S'.($_G['inajax'] ? 'A' : '').$_G['sid'] : $sechash.random(3);
...
<li id="ttp_all" <?php if(!$_GET['typeid'] && !$_GET['sortid']) { ?>class="xw1 a"<?php } ?>><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?><?php if($_G['forum']['threadsorts']['defaultshow']) { ?>&amp;filter=sortall&amp;sortall=1<?php } if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>">全部</a></li><span class="pipe">|</span>
...
<?php if(empty($_G['forum']['sortmode'])) { ?><style>.tl td.num, .tl td.by { width:0px; height:0; overflow:hidden;}.tl .icn {padding-left: 4px;width: 0px;} .tl .th { line-height:45px;}</style>
<div id="threadlist" class="tl kym_threadlist kym_bmw"<?php if($_G['uid']) { ?> style="position: relative;"<?php } ?>>
...
<a id="filter_special" href="javascript:;" class="showmenu xi2<?php if($_GET['specialtype']) { ?> xw1<?php } ?>" onclick="showMenu(this.id)">全部主题</a></span>
<span class="showmenu_outer">
<a id="filter_time" class="showmenu xi2<?php if($_GET['dateline']) { ?> xw1<?php } ?>" onclick="showMenu(this.id)" href="javascript:;"> 全部时间 </a>
</span>
排序：
<span class="showmenu_outer">
...
<div class="y">			
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=lastpost&amp;orderby=lastpost<?php echo $forumdisplayadd['lastpost'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" class="xi2<?php if($_GET['filter'] == 'lastpost') { ?> xw1<?php } ?>">最新</a>&nbsp;<span class="pipe">|</span>
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=heat&amp;orderby=heats<?php echo $forumdisplayadd['heat'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" class="xi2<?php if($_GET['filter'] == 'heat') { ?> xw1<?php } ?>">热门</a>&nbsp;<span class="pipe">|</span>
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=hot" class="xi2<?php if($_GET['filter'] == 'hot') { ?> xw1<?php } ?>">热帖</a>&nbsp;<span class="pipe">|</span>
...
<tbody>
<tr>
<td class="icn" style="width:20px" ><img src="<?php echo IMGDIR;?>/ann_icon.gif" alt="公告" /></td>
...
<?php if(empty($announcement['type'])) { } else { } ?>
<td class="by">
...
<div class="avatarbox"><a class="avatar" href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" class="a1" target="_blank"><img src="uc_server/avatar.php?uid=<?php echo $thread['authorid'];?>&amp;size=small" /></a></div>
<div class="tl_ct">
<a class="y views" href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;extra=<?php echo $extra;?>" style="font-size:14px;"><?php if($thread['isgroup'] != 1) { ?><?php echo $thread['views'];?><?php } else { ?><?php echo $groupnames[$thread['tid']]['views'];?><?php } ?></a>
...
<div class="info">
<em class="y replies"><a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;extra=<?php echo $extra;?>" class="xi2"><?php echo $thread['allreplies'];?></a></em>
<em>
...
<em>于<span<?php if($thread['istoday']) { ?> class="xi1"<?php } ?>><?php echo $thread['dateline'];?></span>发表</em>
<em>
最后回复
<a href="<?php if($thread['digest'] != -2 && !$thread['ordertype']) { ?>forum.php?mod=redirect&tid=<?php echo $thread['tid'];?>&goto=lastpost<?php echo $highlight;?>#lastpost<?php } else { ?>forum.php?mod=viewthread&tid=<?php echo $thread['tid'];?><?php if(!$thread['ordertype']) { ?>&page=<?php echo max(1, $thread['pages']);; } } ?>"><?php echo $thread['lastpost'];?></a>
...
<?php } else { ?>
<div id="pgbtn" class="pgbtn">
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=<?php echo $filter;?>&amp;orderby=<?php echo $_GET['orderby'];?><?php echo $forumdisplayadd['page'];?>&amp;<?php echo $multipage_archive;?>&amp;page=<?php echo $nextpage;?>" hidefocus="true">下一页 &raquo;</a>
<?php } ?></div>
<?php } ?>

<div class="bm bw0 pgs cl">
<span <?php if($_G['setting']['visitedforums']) { ?>id="visitedforumstmp" onmouseover="$('visitedforums').id = 'visitedforumstmp';this.id = 'visitedforums';showMenu({'ctrlid':this.id,'pos':'21'})"<?php } ?> class="pgb"><a href="forum.php">返&nbsp;回</a></span><span id="fd_page_bottom"><?php echo $multipage;?></span>
