...
0
|| checktplrefresh('./template/default/portal/view.htm', './template/kym_xiaomi/portal/portal_comment.htm', 1437026605, 'diy', './data/template/3_diy_portal_view.tpl.php', './template/kym_xiaomi', 'portal/view')
|| checktplrefresh('./template/default/portal/view.htm', './template/default/common/seccheck.htm', 1437026605, 'diy', './data/template/3_diy_portal_view.tpl.php', './template/kym_xiaomi', 'portal/view')
...
<div id="comment_ul" class="bm_c kym_userfont"><?php if(is_array($commentlist)) foreach($commentlist as $comment) { include template('portal/comment_li'); if(!empty($aimgs[$comment['cid']])) { ?>
