...
<div class="kym_sub_bm xm_gd bmw fl<?php if($_G['forum']['forumcolumns']) { ?> flg<?php } ?>">
<div class="bm_h cl">
...
<dd style="color:#434A54;width: 240px; overflow: hidden; white-space: nowrap; font-size:12px;"><?php if($sub['description']) { ?><?php echo $sub['description'];?><?php } else { ?>暂没版块简介<?php } ?></dd>
<?php if(empty($sub['redirect'])) { ?><dd><em  style="color:#999999;font-size:12px;">主题: <?php echo dnumber($sub['threads']); ?></em>, <em  style="color:#999999;font-size:12px;">帖数: <?php echo dnumber($sub['posts']); ?></em></dd><?php } ?>
