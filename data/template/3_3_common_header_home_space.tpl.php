...
0
|| checktplrefresh('./template/kym_xiaomi/common/header.htm', './template/default/common/header_common.htm', 1436859497, '3', './data/template/3_3_common_header_home_space.tpl.php', './template/kym_xiaomi', 'common/header_home_space')
|| checktplrefresh('./template/kym_xiaomi/common/header.htm', './template/kym_xiaomi/common/header_qmenu.htm', 1436859497, '3', './data/template/3_3_common_header_home_space.tpl.php', './template/kym_xiaomi', 'common/header_home_space')
|| checktplrefresh('./template/kym_xiaomi/common/header.htm', './template/kym_xiaomi/member/member.htm', 1436859497, '3', './data/template/3_3_common_header_home_space.tpl.php', './template/kym_xiaomi', 'common/header_home_space')
|| checktplrefresh('./template/kym_xiaomi/common/header.htm', './template/kym_xiaomi/common/pubsearch.htm', 1436859497, '3', './data/template/3_3_common_header_home_space.tpl.php', './template/kym_xiaomi', 'common/header_home_space')
;?>
...
<?php if($_G['uid']) { ?>
        ...
        <div class="xm_um_ex_info">
            <ul class="base_info">
                <li>
                                        <a id="extcreditmenu" href="home.php?mod=spacecp&amp;ac=credit&amp;showcredit=1">积分: <?php echo $_G['member']['credits'];?></a>
                </li>
                <li>
                    <a id="g_upmine" href="home.php?mod=spacecp&amp;ac=usergroup">用户组: <?php echo $_G['group']['grouptitle'];?><?php if($_G['member']['freeze']) { ?>(已冻结)<?php } ?></a>
                </li>
