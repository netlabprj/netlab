...
0
|| checktplrefresh('./template/kym_xiaomi/home/space_menu.htm', './template/default/home/follow_user_header.htm', 1436859497, '3', './data/template/3_3_home_space_menu.tpl.php', './template/kym_xiaomi', 'home/space_menu')
;?>
<style>.bm_c{ padding:5px 10px 10px 10px;}.p_pop li{width:auto;}.tl .by{padding-right:5px;}.ct1{ background:#FFFFFF; border:1px solid #E1E1E1}.tb{ border:none;} #uhd .tb a {border-bottom-width: 0;} .kym_wp #ct{ margin-top:0px;} #moodfm{ margin-top:20px;}</style>
<?php if($space['uid']) { ?>
<div id="uhd" class="wp">
