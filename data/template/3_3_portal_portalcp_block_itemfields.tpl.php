...
<label for="picway_remote"><input type="radio" class="pr" id="picway_remote" name="picway" onclick="showpicedit()" checked="checked" />远程</label>
<label for="picway_upload"><input type="radio" class="pr" id="picway_upload" name="picway" onclick="showpicedit()" />上传</label><br />
<div id="pic_remote">
<input type="text" name="pic" class="px" id="oldpicurl" value="<?php echo $itemfields['oldpic'];?>" style="width: 280px;" />
<a href="javascript:;" onclick="openCropper($('oldpicurl').value);" class="xi2">裁切</a>
</div>
